...
@Setter
@Embeddable
public class TariffOriginId implements Serializable {
    private static final long serialVersionUID = -3121881566080036084L;
    @NotNull
    ...
    public boolean equals(Object o) {
        ...
        TariffOriginId entity = (TariffOriginId) o;
